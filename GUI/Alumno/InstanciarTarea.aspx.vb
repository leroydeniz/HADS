Public Class InstanciarTarea
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim Codigo As String = datos.Cells(1).Text
        Dim Descripcion As String = datos.Cells(2).Text
        Dim CodAig As String = datos.Cells(3).Text
        Dim HEstimadas As String = datos.Cells(4).Text
        Dim tipoTarea As String = datos.Cells(5).Text
